<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO siswa(nrp,nama,gender)
        VALUES ('$nrp', '$nama', '$gender')";
...
<body>
<h2 class="text-center mt-4 mb-2 text-2xl">Input Data</h2>
<div class="w-full max-w-xs center mb-20 border-2 rounded-md py-10 px-10">
    <form method="post">
        <div class="mb-4">
